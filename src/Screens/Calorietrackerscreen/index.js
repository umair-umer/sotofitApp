                ...
                <ScrollView>
                    ...
                    <View style={styles.bottompad}>
                        <View style={{ position: 'relative' }}>
                            <TextInput style={styles.search} placeholder='Search for a Food...' placeholderTextColor={'#fff'} />
                        ...
                        <TouchableOpacity style={styles.meal} onPress={()=> navigation.navigate('food')}>
                            <View style={{ position: 'relative' }}>
